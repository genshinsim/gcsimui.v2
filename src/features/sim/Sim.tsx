...
export default function Sim() {
  ...
  const handleClearConfig = () => dispatch(setConfig(""));

  return (
    <div className="flex flex-col">
      <div className="pl-6 pr-6">
        <div>
          <div className="text-lg font-medium pb-2">Actions</div>
          <div className="flex flex-row gap-2 pl-3">
            <textarea
              rows={30}
              className="bg-gray-700 resize-none rounded-md whitespace-pre text-xs font-mono w-full"
        ...
        <div className="w-full flex flex-row gap-4 mt-4 p-4">
          <button className="btn btn-primary w-48 flex-1" onClick={handleRun}>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
          ...
          <button
            className="btn btn-secondary w-48 flex-1"
          ...
          <button
            className="btn btn-accent w-48 flex-1"
          ...
          <button className="btn btn-info w-48 flex-1" onClick={handleOpenHelp}>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="far"
      ...
      <Options show={openOpt} onHide={handleCloseOpt} />
      <Help show={openHelp} onHide={handleCloseHelp} />
    </div>
  );
}
